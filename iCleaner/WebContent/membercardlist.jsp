					...
					<table class="table table-bordered">
						...
						<tbody>
							...
							<!-- <button type="button" class="btn btn-danger"> -->
								...
								<td><a href="MemberCardManager?type=findStationById&&stationphone=<%= each.getCard_phone()%>"><button type="button" class="btn btn-info">编辑</button></a></td>
								<td><a href="MemberCardManager?type=deletestation&&stationphone=<%= each.getCard_phone()%>"><button type="button" class="btn btn-danger">删除</button></a></td>
							</tr>
							<%
								}
													}
